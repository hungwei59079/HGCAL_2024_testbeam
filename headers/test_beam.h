...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          orbitNumber;
   Int_t           nHGCDigi;
   Bool_t          HGCDigi_isSiPM[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_tctp[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_adc[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_adcm1[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_tot[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_toa[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_cm[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_flags[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_channel[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_fedId[1665];   //[nHGCDigi]
   UShort_t        HGCDigi_fedReadoutSeq[1665];   //[nHGCDigi]
   Int_t           HGCDigi_chType[1665];   //[nHGCDigi]
   Int_t           HGCDigi_modI1[1665];   //[nHGCDigi]
   Int_t           HGCDigi_modI2[1665];   //[nHGCDigi]
   Int_t           HGCDigi_chI1[1665];   //[nHGCDigi]
   Int_t           HGCDigi_chI2[1665];   //[nHGCDigi]
   Int_t           nHGCHit;
   Bool_t          HGCHit_zSide[1665];   //[nHGCHit]
   UShort_t        HGCHit_flags[1665];   //[nHGCHit]
   Int_t           HGCHit_layer[1665];   //[nHGCHit]
   Float_t         HGCHit_x[1665];   //[nHGCHit]
   Float_t         HGCHit_y[1665];   //[nHGCHit]
   Double_t        HGCHit_energy[1665];   //[nHGCHit]
   Double_t        HGCHit_time[1665];   //[nHGCHit]
...
#ifdef test_beam_cxx
test_beam::test_beam(TTree *tree) : fChain(0) 
{
...
Int_t test_beam::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t test_beam::LoadTree(Long64_t entry)
{
...
void test_beam::Init(TTree *tree)
{
...
void test_beam::Show(Long64_t entry)
{
...
Int_t test_beam::Cut(Long64_t entry)
{
